...
module design_1
  ...
  design_1_syst_array_axil_0_0 syst_array_axil_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .rst_n(proc_sys_reset_0_peripheral_aresetn),
        .s_axil_araddr(axi_protocol_convert_0_M_AXI_ARADDR),
        .s_axil_arprot(axi_protocol_convert_0_M_AXI_ARPROT),
        .s_axil_arready(axi_protocol_convert_0_M_AXI_ARREADY),
        .s_axil_arvalid(axi_protocol_convert_0_M_AXI_ARVALID),
        .s_axil_awaddr(axi_protocol_convert_0_M_AXI_AWADDR),
        .s_axil_awprot(axi_protocol_convert_0_M_AXI_AWPROT),
        .s_axil_awready(axi_protocol_convert_0_M_AXI_AWREADY),
        .s_axil_awvalid(axi_protocol_convert_0_M_AXI_AWVALID),
        .s_axil_bready(axi_protocol_convert_0_M_AXI_BREADY),
        .s_axil_bresp(axi_protocol_convert_0_M_AXI_BRESP),
        .s_axil_bvalid(axi_protocol_convert_0_M_AXI_BVALID),
        .s_axil_rdata(axi_protocol_convert_0_M_AXI_RDATA),
        .s_axil_rready(axi_protocol_convert_0_M_AXI_RREADY),
        .s_axil_rvalid(axi_protocol_convert_0_M_AXI_RVALID),
        .s_axil_wdata(axi_protocol_convert_0_M_AXI_WDATA),
        .s_axil_wready(axi_protocol_convert_0_M_AXI_WREADY),
        .s_axil_wstrb(axi_protocol_convert_0_M_AXI_WSTRB),
        .s_axil_wvalid(axi_protocol_convert_0_M_AXI_WVALID));
endmodule
