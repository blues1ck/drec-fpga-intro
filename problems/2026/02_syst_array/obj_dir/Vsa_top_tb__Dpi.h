...
extern "C" {
    ...
    // DPI IMPORTS
    // DPI import at src/sa_top_tb.sv:6:30
    extern void SetElemA(short Elem, int Pos);
    // DPI import at src/sa_top_tb.sv:7:30
    extern void SetElemB(short Elem, int Pos);
    // DPI import at src/sa_top_tb.sv:8:30
    extern void SetElemC(short Elem, int Pos);
    // DPI import at src/sa_top_tb.sv:9:30
    extern void SetSize(int Size);
    // DPI import at src/sa_top_tb.sv:5:30
